...
const locale = {
  ...
  'trading-assistant.table.source': '来源',
  'trading-assistant.table.compare': '对账',
  ...
  'trading-assistant.records.syncHtx': '同步火币记录',
  'trading-assistant.records.syncHtxSuccess': '火币同步完成：拉取 {fetched}，新增 {inserted}，更新 {updated}，未归属 {unassigned}，跳过 {skipped}',
  'trading-assistant.records.syncHtxFailed': '同步火币记录失败',
  'trading-assistant.records.sourceLocal': '本地',
  'trading-assistant.records.sourceHtx': 'HTX同步',
  'trading-assistant.records.sourceHtxUnassigned': 'HTX未归属',
  'trading-assistant.records.compareMatched': '一致',
  'trading-assistant.records.compareMismatch': '差异',
  'trading-assistant.records.compareLocalOnly': '仅本地',
  'trading-assistant.records.compareCloudOnly': '仅云端',
  'trading-assistant.records.unassignedSummary': '未归属交易所记录',
